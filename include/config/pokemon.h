...
#define P_UPDATED_ABILITIES         GEN_3  // Since Gen 4, certain Pokémon have had their abilities changed.
...
#define P_EVOLUTION_LEVEL_1_LEARN   GEN_3  // Since Gen 8, Pokémon evolving while at level 1 do not get the chance to learn their level 1 moves, while before they did.
...
#define P_EGG_MOVE_TRANSFER            GEN_8                // Starting in Gen 8, if two Pokémon of the same species are together in the Day Care, one knows an Egg Move, and the other has an empty slot, the other Pokémon will receive the Egg Move in the empty slot. In Gen 9, if a Pokémon holds a Mirror Herb, it will receive Egg Moves from the other regardless of species.
